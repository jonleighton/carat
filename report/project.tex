...
\usepackage[breaklinks=true,colorlinks=true,linkcolor=MidnightBlue]{hyperref}
\usepackage{listings}
...
\pdfinfo {
	/Author (Jonathan Leighton)
	/Title (Carat: An interpreter written in Ruby)
	/Subject (Carat: An interpreter written in Ruby)
	/Keywords ()
	/CreationDate (\today)
}
\fi

\newcommand{\code}[1]{\texttt{\textcolor{Mahogany}{{#1}}}}
