class Carat::Runtime
  class Module < Object
    ...
    # Modules has a metaclass so that they can have module methods. The class of the metaclass is
    # always +Module+.
    def get_klass(runtime)
      MetaClass.new(runtime, self, runtime.constants[:Module])
    end
    
    # The bootstrap module is the module containing specific behaviour and primitives for this
    # module or class.
    # 
    ...
    def extensions_module
      bootstrap_submodule(:Extensions)
    end
    ...
    def primitives_module
      bootstrap_submodule(:Primitives)
    end
    
    # Modules defining primitives for instances of this class, or instances of classes which include
    # this module. For each instance, all of the primitive modules need to be singleton_included, 
    # so we get a full list using the inheritance hierarchy.
    def primitives
      @primitives = []
      @primitives += self.super.primitives if self.super
